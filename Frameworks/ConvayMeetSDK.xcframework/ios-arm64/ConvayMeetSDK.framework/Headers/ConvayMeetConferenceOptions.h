...
#import "ConvayMeetUserInfo.h"


@interface ConvayMeetConferenceOptionsBuilder : NSObject
...
@interface ConvayMeetConferenceOptions : NSObject
...
+ (instancetype _Nonnull)fromBuilder:(void (^_Nonnull)(ConvayMeetConferenceOptionsBuilder *_Nonnull))initBlock;
