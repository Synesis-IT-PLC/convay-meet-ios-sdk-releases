 ...
 * with those passed to ConvayMeetView.join when joining a conference.
 */
@property (nonatomic, nullable) ConvayMeetConferenceOptions *defaultConferenceOptions;
...
- (ConvayMeetConferenceOptions *_Nonnull)getInitialConferenceOptions;
